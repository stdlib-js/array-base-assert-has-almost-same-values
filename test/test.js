...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof hasAlmostSameValues, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'the function returns `true` if both arrays have respective elements which are approximately the same value (generic)', function test( t ) {
	var out;
	var x;
	var y;
...
tape( 'the function returns `true` if both arrays have respective elements which are approximately the same value (real typed array)', function test( t ) {
	var out;
	var x;
	var y;
	...
	x = new Float64Array( [ 0.0, 2.0, NaN ] );
	y = new Float64Array( [ 0.0, 2.0, NaN ] );
	out = hasAlmostSameValues( x, y, 0 );
	t.strictEqual( out, true, 'returns expected value' );
...
tape( 'the function returns `true` if both arrays have respective elements which are approximately the same value (mixed)', function test( t ) {
	var out;
	var x;
	var y;
...
tape( 'the function returns `true` if both arrays have respective elements which are approximately the same value (boolean array)', function test( t ) {
	var out;
	var x;
	var y;
...
tape( 'the function returns `true` if both arrays have respective elements which are approximately the same value (complex typed array)', function test( t ) {
	var out;
	var x;
	var y;
	...
	x = new Complex128Array( [ 0.0, 0.0, 3.0, NaN ] );
	y = new Complex128Array( [ 0.0, 0.0, 3.0, NaN ] );
	out = hasAlmostSameValues( x, y, 0 );
	t.strictEqual( out, true, 'returns expected value' );
...
tape( 'the function returns `true` if both arrays have respective elements which are approximately the same value (accessor)', function test( t ) {
	var out;
	var x;
	var y;
...
tape( 'the function returns `true` if both arrays have respective elements which are approximately the same value (array-like object)', function test( t ) {
	var out;
	var x;
	var y;
...
tape( 'the function returns `false` if both arrays do not have respective elements which are approximately the same value (generic)', function test( t ) {
	var out;
	var x;
	var y;
...
tape( 'the function returns `false` if both arrays do not have respective elements which are approximately the same value (real typed array)', function test( t ) {
	var out;
	var x;
	var y;
...
tape( 'the function returns `false` if both arrays do not have respective elements which are approximately the same value (mixed)', function test( t ) {
	var out;
	var x;
	var y;
...
tape( 'the function returns `false` if both arrays do not have respective elements which are approximately the same value (boolean array)', function test( t ) {
	var out;
	var x;
	var y;
...
tape( 'the function returns `false` if both arrays do not have respective elements which are approximately the same value (complex typed array)', function test( t ) {
	var out;
	var x;
	var y;
...
tape( 'the function returns `false` if both arrays do not have respective elements which are approximately the same value (accessor)', function test( t ) {
	var out;
	var x;
	var y;
...
tape( 'the function returns `false` if both arrays do not have respective elements which are approximately the same value (array-like object)', function test( t ) {
	var out;
	var x;
	var y;
